...
{
	// configure all port 0 pins as digital push-pull outputs
	// set reset_n, address lines low
	// set RD_n, WR_n, CSL_n, CSR_n high
	P0MDIN  = 0xFF; // digital; not analog
...
{
	// configure all port 1 pins digital push-pull outputs and set them low
	P1MDIN  = 0xFF; // digital; not analog
	P1MDOUT = 0xFF; // push-pull
	P1      = 0x00; // data

	// crossbar skips all port 1 pins
	P1SKIP  = 0xff;
}
...
{
	// P2.0 to P2.7 open drain digital outputs, will set
	// one bit low at a time to scan key matrix
	P2MDIN  = 0xFF;  // digital; not analog
	P2MDOUT = 0x02;  // open drain except P2.1 which is the direction pin
	P2      = 0xFF;  // pull high P2.1, float high others, direction = A->B => EFM 2 XPT
...
{
	// P3.7 to P3.4 open drain digital outputs
	// P3.3 to P3.0 analog inputs
	P3MDIN  = 0xFF;  // digital; not analog
	P3MDOUT = 0x00;  // open drain
	P3      = 0xFF;  // float high, USER LED on P3.5
...
{
	// P4.0 to P4.7 open drain digital inputs
	P4MDIN  = 0xFF;  // digital; not analog
	P4MDOUT = 0x00;  // open drain
	P4      = 0xFF;  // float high
}
