...
// report 1: set display digits, 9 bytes
// report 2: get keyboard keys, 8 bytes
// report 3: get ADC values, 6 bytes
// report 4: set button lamps, 5 bytes
...
#define MFR_SIZE                                14
#define PROD_STRING                            '3','0','0',' ','M','/','E',' ','B','U','S','\0'
#define PROD_SIZE                               12
