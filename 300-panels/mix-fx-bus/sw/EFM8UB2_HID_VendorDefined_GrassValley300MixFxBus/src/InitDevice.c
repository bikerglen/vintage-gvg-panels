...
extern void PORTS_0_enter_DefaultMode_from_RESET (void)
{
	...
	P0MDOUT = 0x00; // open drain
	P0      = 0x00; // low
	P0SKIP  = 0xff; // crossbar skips all P0 pins
}
...
extern void PORTS_1_enter_DefaultMode_from_RESET(void)
{
	...
	P1      = 0x00; // low
	P1SKIP  = 0xff; // crossbar skips all P1 pins
}
...
extern void PORTS_2_enter_DefaultMode_from_RESET(void)
{
	...
	P2      = 0x7f; // all high except bit 7
	P2SKIP  = 0xff; // crossbar skips all P1 pins
}
...
extern void PORTS_3_enter_DefaultMode_from_RESET(void)
{
	...
	P3      = 0x7f; // all high except bit 7
	P3SKIP  = 0xff; // crossbar skips all P1 pins
}
